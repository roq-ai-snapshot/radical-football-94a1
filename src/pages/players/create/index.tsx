    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="training_progress" mb="4" isInvalid={!!formik.errors?.training_progress}>
            <FormLabel>Training Progress</FormLabel>
            <Input
              type="text"
              name="training_progress"
              value={formik.values?.training_progress}
              onChange={formik.handleChange}
            />
            {formik.errors.training_progress && <FormErrorMessage>{formik.errors?.training_progress}</FormErrorMessage>}
          </FormControl>
